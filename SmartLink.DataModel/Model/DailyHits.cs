...
{
    public partial class DailyHits
    {
        public DailyHits()
        {
            DailyHitsChannelMetaData = new HashSet<DailyHitsChannelMetaData>();
        }
        ...
        public bool? MonthlySync { get; set; }
        public DateTime? MonthlySyncDate { get; set; }
        public int? TemplateId { get; set; }
        public bool? IsAutomatedDefinition { get; set; }

        public virtual ICollection<DailyHitsChannelMetaData> DailyHitsChannelMetaData { get; set; }
    }
}
